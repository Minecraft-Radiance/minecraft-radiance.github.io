window.translations = {
    'zh': {
        ...
        'features_page.upscale.point3': '<a href="https://github.com/intel/xess" target="_blank" class="underline hover:text-orange-400">Intel XeSS SR</a> - 已支持 (Windows 版本)',
...
<div class="bg-yellow-900/30 border border-yellow-500/50 p-4 mt-8 rounded text-sm text-yellow-200"><span class="font-bold">注意：</span> Windows 用户首先请尝试处理（重命名、删除等）JDK bin 文件夹（<code>{JDK路径}/bin/</code>）中的 <code>msvcp140.dll</code>, <code>vcruntime140.dll</code> 和 <code>vcruntime140_1.dll</code>，使 these 文件在该文件夹中不存在。此步骤旨在移除 JDK 对这些库的依赖。然后，安装最新的 <a href="https://learn.microsoft.com/en-us/cpp/windows/latest-supported-vc-redist?view=msvc-170" class="underline">Microsoft Visual C++ Redistributable</a>。</div>
        ...
        'changelog.v0_1_4.item4': '集成 Nvidia <a href="https://github.com/NVIDIA-RTX/SHARC" target="_blank" class="underline hover:text-orange-400">SHaRC</a> 和 <a href="https://github.com/intel/xess" target="_blank" class="underline hover:text-orange-400">XeSS SR</a>（仅限 Windows）',
        'changelog.v0_1_4.item5': '改进光线追踪模块：公开部分 RT 着色器以供运行时修改（实验性），优化内部着色器以减少寄存器和 SM 使用，分离反射和折射路径',
        'changelog.v0_1_4.item6': '重写 NRD 模块：遵循 <a href="https://github.com/NVIDIA-RTX/NRD-Sample" target="_blank" class="underline hover:text-orange-400">NRD 示例</a>，改进 Reblur 反射效果，公开几乎所有 ReBlur 设置',
    ...
    'en': {
        ...
        'features_page.upscale.point3': '<a href="https://github.com/intel/xess" target="_blank" class="underline hover:text-orange-400">Intel XeSS SR</a> - Supported (Windows)',
...
<div class="bg-yellow-900/30 border border-yellow-500/50 p-4 mt-8 rounded text-sm text-yellow-200"><span class="font-bold">NOTE:</span> For Windows users, first, try to manipulate (rename, delete, etc.) the <code>msvcp140.dll</code>, <code>vcruntime140.dll</code> and <code>vcruntime140_1.dll</code> in the JDK's bin folder (<code>{JDK_PATH}/bin/</code>) so that these files do not exist in that folder. This step aims to remove the JDK's dependency on those libraries. Then, install the latest <a href="https://learn.microsoft.com/en-us/cpp/windows/latest-supported-vc-redist?view=msvc-170">Microsoft Visual C++ Redistributable</a>.</div>
        ...
        'changelog.v0_1_5.title': 'v0.1.5-alpha',
        'changelog.v0_1_5.date': '2026-04-30',
        'changelog.v0_1_5.item1': 'Supports individual shaderpacks: Features internal [<a href="https://github.com/Minecraft-Radiance/Shaderpack-Vanilla-PT" target="_blank" class="underline hover:text-orange-400">Vanilla PT</a>] and [<a href="https://github.com/Minecraft-Radiance/Shaderpack-Advanced" target="_blank" class="underline hover:text-orange-400">Advanced</a>] versions with basic path tracing, normal mapping, parallax, realistic water (caustics), ReSTIR (Advanced only), volumetric light/cloud, and motion blur',
        ...
        'changelog.v0_1_4.item4': 'Integrated Nvidia <a href="https://github.com/NVIDIA-RTX/SHARC" target="_blank" class="underline hover:text-orange-400">SHaRC</a> and <a href="https://github.com/intel/xess" target="_blank" class="underline hover:text-orange-400">XeSS SR</a> (Windows only)',
        ...
        'changelog.v0_1_4.item6': 'Rewrite NRD module: Following <a href="https://github.com/NVIDIA-RTX/NRD-Sample" target="_blank" class="underline hover:text-orange-400">NRD sample</a>, improved reflections with Reblur, exposed more settings',
